  ...
  (color-theme-install
   '(color-theme-twilight
     ((background-color . "#141414")
      ...
      (mouse-color . "sienna1"))
     (default ((t (:background "#141414" :foreground "#cccccc"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "#141414" :foreground "#cccccc"))))
     ...
     (gui-element ((t (:background "#D4D0C8" :foreground "#141414"))))
     (region ((t (:foreground: nil :background "#27292A"))))
     (mode-line ((t (:background "grey75" :foreground "#141414"))))
     (highlight ((t (:background "#222222"))))
     (highline-face ((t (:background "SeaGreen"))))
     (italic ((t (nil))))
     (left-margin ((t (nil))))
     (text-cursor ((t (:background "yellow" :foreground "#141414"))))
     (toolbar ((t (nil))))
